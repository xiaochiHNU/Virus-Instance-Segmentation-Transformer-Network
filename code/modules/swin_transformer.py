...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, pretrain_img_size=224, patch_size=4, in_chans=3, embed_dim=96, depths=(2, 2, 6, 2),  # (2, 2, 18, 2)
...
if __name__ == '__main__':
    ...
    net = SwinTransformer()
    net.init_backbone('../weights/swin_small_patch4_window7_224.pth')
    aa = torch.randn(1, 3, 544, 544)    # 输入图像 3, 544,544
    out = net(aa)   # out一共有四组, out0 96,136,136, out1 192,68,68, out2 384,34,34, out3 768,17,17
