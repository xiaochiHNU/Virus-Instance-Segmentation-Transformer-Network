...
from utils_yolcat.coco import COCODetection, val_collate
from modules.yolact import Yolact
from utils_yolcat import timer
from utils_yolcat.output_utils import after_nms, nms
from utils_yolcat.common_utils import ProgressBar, MakeJson, APDataObject, prep_metrics, calc_map
from config import get_config

parser = argparse.ArgumentParser(description='YOLACT COCO Evaluation')
parser.add_argument('--img_size', type=int, default=896, help='The image size for validation.')
parser.add_argument('--weight', type=str, default='weights/loss_0.47_swin_transformer_7850.pth')
...
def evaluate(net, cfg, step=None):
    ...
    data_loader = data.DataLoader(dataset, 4, num_workers=0, shuffle=False,  #  cfg.bs_per_gpu = 4
